# -*- coding: utf-8 -*-
#
# multiprocess documentation build configuration file, created by
...
version = multiprocess.__version__
...
modindex_common_prefix = ['multiprocess.']
...
htmlhelp_basename = 'multiprocessdoc'
