...
class TestResourceTracker(unittest.TestCase):
    ...
    @unittest.skipIf(sys.hexversion <= 0x30d0df0, "added in 3.13.14")
...
class _TestSpawnedSysPath(BaseTestCase):
    ...
    @unittest.skipIf(sys.hexversion <= 0x30d05f0, "added in 3.13.6")
...
class MiscTestCase(unittest.TestCase):
    ...
    @unittest.skipIf(sys.hexversion <= 0x30d0bf0, "added in 3.13.12")
    ...
    @unittest.skipIf(sys.hexversion <= 0x30d0df0, "added in 3.13.13")
...
@unittest.skipIf(sys.hexversion <= 0x30d09f0, "added in 3.13.10")
@unittest.skipUnless(HAS_SHMEM, "requires multiprocess.shared_memory")
